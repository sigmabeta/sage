...
class AndroidStringProvider(
    ...
    override fun getString(string: SageStringId) =
        resources.getString(toResourceId(string))

    override fun getStringOneArg(string: SageStringId, arg: String) =
        resources.getString(toResourceId(string), arg)

    override fun getStringOneInt(string: SageStringId, arg: Int) =
        resources.getString(toResourceId(string), arg)
