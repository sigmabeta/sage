...
val md_theme_light_surfaceTint = Color(0xFF8C33B3)
val md_theme_light_outlineVariant = Color(0xFFCEC3CD)
val md_theme_light_scrim = Color(0xFF000000)

val seed = Color(0xFF8C33B3)

val VglsLight = lightColorScheme(
