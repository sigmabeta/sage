...
package net.sigmabeta.sage.ui.colors

import androidx.compose.material3.darkColorScheme
import androidx.compose.ui.graphics.Color

val md_theme_dark_primary = Color(0xFFEBB2FF)
val md_theme_dark_onPrimary = Color(0xFF520072)
val md_theme_dark_primaryContainer = Color(0xFF721099)
val md_theme_dark_onPrimaryContainer = Color(0xFFF8D8FF)
val md_theme_dark_secondary = Color(0xFFFFABEF)
val md_theme_dark_onSecondary = Color(0xFF5B0557)
val md_theme_dark_secondaryContainer = Color(0xFF76246F)
