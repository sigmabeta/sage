...
internal val VglsMaterialVectors.IcJamFilled: ImageVector
    get() {
        if (_icJamFilled != null) {
            return _icJamFilled!!
        }
        _icJamFilled = Builder(
            ...
            path(
                ...
                curveToRelative(4.0f, 0.0f, 8.0839f, -3.9559f, 8.0607f, -8.9558f)
                lineTo(40.0f, 22.0f)
                curveToRelative(0.0f, -3.7408f, -4.0f, -7.0f, -6.0f, -8.0f)
                horizontalLineTo(14.0f)
                curveToRelative(-2.0f, 1.0f, -5.9721f, 4.3255f, -6.0f, 8.0f)
                verticalLineToRelative(2.0f)
                horizontalLineToRelative(4.0f)
                verticalLineToRelative(-3.0f)
                curveToRelative(0.0f, -0.4714f, 0.5286f, -1.0f, 1.0f, -1.0f)
                curveToRelative(0.4714f, 0.0f, 1.0f, 0.5286f, 1.0f, 1.0f)
                ...
                curveToRelative(0.0f, 5.0f, 4.0f, 9.0f, 8.0f, 9.0f)
                close()
            }
            path(
...
private var _icJamFilled: ImageVector? = null
